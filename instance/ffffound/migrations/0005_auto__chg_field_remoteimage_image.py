...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RemoteImage.image'
        db.alter_column(u'ffffound_remoteimage', 'image', self.gf('leica.modelfields.NDImage')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'RemoteImage.image'
        db.alter_column(u'ffffound_remoteimage', 'image', self.gf('leica.modelfields.RemoteImageField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'ffffound.remoteimage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('leica.modelfields.NDImage', [], {'db_index': 'True', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
